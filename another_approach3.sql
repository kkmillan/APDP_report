/*SELECT FROM ODPO T0 WHERE T0."DocDate" >=[%0] T0."DocDate" <=[%1] T0."CardCode" =[%2] T0."CardCode" =[%3] T0."CardCode" =[%4];*/
...
--
where T0."APDP_Doc date" >= '[%0]'
AND T0."APDP_Doc date" <= '[%1]'
AND (T0."Vendor Code" = '[%2]' or ('[%2]' = '' and '[%3]' = '' and '[%4]' = '' )) or T0."Vendor Code" = '[%3]' or T0."Vendor Code" = '[%4]'